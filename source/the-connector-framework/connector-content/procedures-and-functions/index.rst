...
spMFCreateTable : Used to create MF Class table with associated Properties
spMFDecrypt : CLR procedure used to decrypt the password
spMFDeleteAdhocProperty : Used to delete adhoc properties associated with an object 
spMFDeleteObject :  Used to delete an object from M-Files
spMFDeleteObjectList : Used to delete a list of objects from M-Files 
